...
public class GraphicsUtils {
    ...
    public static void drawRect(float x, float y, float width, float height, float thickness) {
        SpriteBatch batch = Core.batch;
        Resources resources = Core.resources;
    ...
    public static void drawLine(float x1, float y1, float x2, float y2, float thickness) {
        ...
        Core.batch.draw(Core.resources.box, x1, y1, 0, 0, dist, thickness, 1, 1, rad);
    }
}
